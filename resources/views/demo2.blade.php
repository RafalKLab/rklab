...
<head>
    ...
    =============================================
    -->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('/demo2/assets/images/favicons/apple-icon-57x57.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('/demo2/assets/images/favicons/apple-icon-60x60.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('/demo2/assets/images/favicons/apple-icon-72x72.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('/demo2/assets/images/favicons/apple-icon-76x76.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('/demo2/assets/images/favicons/apple-icon-114x114.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('/demo2/assets/images/favicons/apple-icon-120x120.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('/demo2/assets/images/favicons/apple-icon-144x144.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('/demo2/assets/images/favicons/apple-icon-152x152.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('/demo2/assets/images/favicons/apple-icon-180x180.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('/demo2/assets/images/favicons/android-icon-192x192.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/demo2/assets/images/favicons/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('/demo2/assets/images/favicons/favicon-96x96.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/demo2/assets/images/favicons/favicon-16x16.png') }}">
    ...
    -->
    <!-- Default stylesheets-->
    <link href="{{ asset('/demo2/assets/lib/bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Template specific stylesheets-->
    <link href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Volkhov:400i" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/animate.css/animate.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/components-font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/et-line-font/et-line-font.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/flexslider/flexslider.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/owl.carousel/dist/assets/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/owl.carousel/dist/assets/owl.theme.default.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/magnific-popup/dist/magnific-popup.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo2/assets/lib/simple-text-rotator/simpletextrotator.css') }}" rel="stylesheet">
    <!-- Main stylesheet and color file-->
    <link href="{{ asset('/demo2/assets/css/style.css') }}" rel="stylesheet">
    <link id="color-scheme" href="{{ asset('/demo2/assets/css/colors/default.css') }}" rel="stylesheet">
</head>
        ...
        <section class="module pb-0" id="works">
            ...
            <ul class="works-grid works-grid-gut works-grid-3 works-hover-w" id="works-grid">
                <li class="work-item illustration webdesign"><a href="portfolio-single-1.html">
                        <div class="work-image"><img src="{{ asset('/demo2/assets/images/work-1.jpg') }}" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Corporate Identity</h3>
                            <div class="work-descr">Illustration</div>
                        </div></a></li>
                <li class="work-item marketing photography"><a href="portfolio-single-1.html">
                        <div class="work-image"><img src="{{ asset('/demo2/assets/images/work-2.jpg') }}" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Bag MockUp</h3>
                            <div class="work-descr">Marketing</div>
                        </div></a></li>
                <li class="work-item illustration photography"><a href="portfolio-single-1.html">
                        <div class="work-image"><img src="{{ asset('/demo2/assets/images/work-3.jpg') }}" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Disk Cover</h3>
                            <div class="work-descr">Illustration</div>
                        </div></a></li>
                <li class="work-item marketing photography"><a href="portfolio-single-1.html">
                        <div class="work-image"><img src="{{ asset('/demo2/assets/images/work-4.jpg') }}" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Business Card</h3>
                            <div class="work-descr">Photography</div>
                        </div></a></li>
                <li class="work-item illustration webdesign"><a href="portfolio-single-1.html">
                        <div class="work-image"><img src="{{ asset('/demo2/assets/images/work-5.jpg') }}" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
                            <h3 class="work-title">Business Card</h3>
                            <div class="work-descr">Webdesign</div>
                        </div></a></li>
                <li class="work-item marketing webdesign"><a href="portfolio-single-1.html">
                        <div class="work-image"><img src="{{ asset('/demo2/assets/images/work-6.jpg') }}" alt="Portfolio Item"/></div>
                        <div class="work-caption font-alt">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                        <div class="alt-services-image align-center"><img src="{{ asset('/demo2/assets/images/promo.png') }}" alt="Feature Image"></div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="alt-features-item">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{ asset('/demo2/assets/images/team-1.jpg') }}" alt="Member Photo"/>
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{ asset('/demo2/assets/images/team-2.jpg') }}" alt="Member Photo"/>
                                <div class="team-detail">
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{ asset('/demo2/assets/images/team-3.jpg') }}" alt="Member Photo"/>
                                <div class="team-detail">
                    ...
                    <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                        <div class="team-item">
                            <div class="team-image"><img src="{{ asset('/demo2/assets/images/team-4.jpg') }}" alt="Member Photo"/>
                                <div class="team-detail">
                ...
                <div class="row multi-columns-row post-columns">
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="post mb-20">
                            <div class="post-thumbnail"><a href="#"><img src="{{ asset('/demo2/assets/images/post-1.jpg') }}" alt="Blog-post Thumbnail"/></a></div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="post mb-20">
                            <div class="post-thumbnail"><a href="#"><img src="{{ asset('/demo2/assets/images/post-2.jpg') }}" alt="Blog-post Thumbnail"/></a></div>
                            <div class="post-header font-alt">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="post mb-20">
                            <div class="post-thumbnail"><a href="#"><img src="{{ asset('/demo2/assets/images/post-3.jpg') }}" alt="Blog-post Thumbnail"/></a></div>
                            <div class="post-header font-alt">
                    ...
                    <div class="col-sm-3">
                        <div class="widget">
                            ...
                            <ul class="widget-posts">
                                <li class="clearfix">
                                    <div class="widget-posts-image"><a href="#"><img src="{{ asset('/demo2/assets/images/rp-1.jpg') }}" alt="Post Thumbnail"/></a></div>
                                ...
                                <li class="clearfix">
                                    <div class="widget-posts-image"><a href="#"><img src="{{ asset('/demo2/assets/images/rp-2.jpg') }}" alt="Post Thumbnail"/></a></div>
                                    <div class="widget-posts-body">
...
=============================================
-->
<script src="{{ asset('/demo2/assets/lib/jquery/dist/jquery.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/wow/dist/wow.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/jquery.mb.ytplayer/dist/jquery.mb.YTPlayer.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/isotope/dist/isotope.pkgd.js')}}"></script>
<script src="{{ asset('/demo2/assets/lib/imagesloaded/imagesloaded.pkgd.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/flexslider/jquery.flexslider.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/owl.carousel/dist/owl.carousel.min.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/smoothscroll.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/magnific-popup/dist/jquery.magnific-popup.js') }}"></script>
<script src="{{ asset('/demo2/assets/lib/simple-text-rotator/jquery.simple-text-rotator.min.js') }}"></script>
<script async="" defer="" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDK2Axt8xiFYMBMDwwG1XzBQvEbYpzCvFU"></script>
<script src="{{ asset('/demo2/assets/js/plugins.js') }}"></script>
