...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('/demo4/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('/demo4/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,600,600i,700,700i" rel="stylesheet">

    <!-- Vendor CSS Files -->
    <link href="{{ asset('/demo4/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/demo4/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="{{ asset('/demo4/assets/css/style.css') }}" rel="stylesheet">
...
<main id="main">
    ...
    <section id="about" class="about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img src="{{ asset('/demo4/assets/img/about-img.jpg') }}" class="img-fluid" alt="">
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="card">
                        <img src="{{ asset('/demo4/assets/img/why-us-1.jpg') }}" class="card-img-top" alt="...">
                        <div class="card-icon">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="card">
                        <img src="{{ asset('/demo4/assets/img/why-us-2.jpg') }}" class="card-img-top" alt="...">
                        <div class="card-icon">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="card">
                        <img src="{{ asset('/demo4/assets/img/why-us-3.jpg') }}" class="card-img-top" alt="...">
                        <div class="card-icon">
...
<!-- Vendor JS Files -->
<script src="{{ asset('/demo4/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('/demo4/assets/vendor/php-email-form/validate.js') }}"></script>

<!-- Template Main JS File -->
<script src="{{ asset('/demo4/assets/js/main.js') }}"></script>
